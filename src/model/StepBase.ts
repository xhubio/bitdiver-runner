...
export abstract class StepBase {
   ...
   * testcases
   */
  async logDebug(messageObj: any, environmentTestcase?: EnvironmentTestcase): Promise<void> {
   ...
   * will only be written for this testcase. If not the log will be written for all the
   */
  async logInfo(messageObj: any, environmentTestcase?: EnvironmentTestcase): Promise<void> {
   ...
   * will only be written for this testcase. If not the log will be written for all the
   */
  async logWarning(messageObj: any, environmentTestcase?: EnvironmentTestcase): Promise<void> {
   ...
   * will only be written for this testcase. If not the log will be written for all the
   */
  async logError(messageObj: any, environmentTestcase?: EnvironmentTestcase): Promise<void> {
   ...
   * will only be written for this testcase. If not the log will be written for all the
   */
  async logFatal(messageObj: any, environmentTestcase?: EnvironmentTestcase): Promise<void> {
  ...
  async _log(
    ...
    if (this.environmentRun === undefined || environmentTestcase === undefined) {
