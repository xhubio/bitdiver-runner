 ...
 */
export function getLogLevelName(levelNumber?: number | string | undefined): string {
 ...
 */
function isValidLoglevelString(value: string): value is keyof typeof LOG_LEVEL_NAME_TO_NUM {
